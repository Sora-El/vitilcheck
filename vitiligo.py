...
template_dir = os.path.abspath(r"C:\Users\USUARIO\Downloads\pagina_vitiligo\templates")
app = Flask(__name__, template_folder=template_dir)

# Cargar el modelo desde JSON
json_file = open(r"C:\Users\USUARIO\Downloads\pagina_vitiligo\datosvitil.json", 'r')
model_json = json_file.read()
json_file.close()

model = model_from_json(model_json)
model.load_weights(r"C:\Users\USUARIO\Downloads\pagina_vitiligo\datosvitil.weights.h5")
...
def upload_file():
    ...
    if file:
        try:
            ...
            # Devuelve el resultado en formato JSON para que AJAX lo maneje
